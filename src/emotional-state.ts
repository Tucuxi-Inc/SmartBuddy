...
export const EMOTION_TRAIT_MODIFIERS: Readonly<
  Record<EmotionValue, Readonly<Record<string, number>>>
> = {
  [Emotion.JOY]: {
    extraversion: 0.10,
    optimism: 0.15,
...
export class EmotionalSystem {
  ...
  private readonly modifierVectors: Map<EmotionValue, number[]>;
