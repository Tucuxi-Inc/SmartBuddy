 ...
 */
import { TRAIT_NAME_TO_INDEX, dampenTraitUpdate } from "./traits.js";
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export const TRAIT_CORRELATION_MATRIX = new Map([
...
export const EVOLUTION_RULES = new Map([
...
export class PersonalityEvolutionEngine {
     ...
     */
    createShift(trigger, tick, baseMagnitude = 0.05, decayTicks = 100) {
     ...
     */
    applyShifts(traits, shifts, currentTick) {
     ...
     */
    static currentMagnitude(shift, currentTick) {
        const elapsed = currentTick - shift.tickCreated;
        if (elapsed < 0)
            return shift.magnitude; // future shift — full strength
        if (elapsed >= shift.decayTicks)
            return 0.0;
     ...
     */
    static getActiveShifts(shifts, currentTick) {
...
//# sourceMappingURL=personality-evolution.js.map