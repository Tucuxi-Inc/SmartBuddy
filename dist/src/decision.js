...
import { TRAIT_INDEX_TO_NAME, TRAIT_COUNT } from "./traits.js";
import { dot, mul, softmax } from "./math.js";
// ---------------------------------------------------------------------------
...
export class DecisionModel {
     ...
     */
    constructor(traitSystem, temperature = 1.0, weightSeed = 0) {
     ...
     */
    decide(traits, situation, actions, actionWeights, actionBiases, councilModulation, directorBiases, rng) {
    ...
    _weightedSelect(probabilities, rng) {
