...
// Index look-ups
// ---------------------------------------------------------------------------
export const TRAIT_NAME_TO_INDEX = new Map(TRAITS.map(t => [t.name, t.index]));
export const TRAIT_INDEX_TO_NAME = new Map(TRAITS.map(t => [t.index, t.name]));
// ---------------------------------------------------------------------------
...
export class TraitSystem {
     ...
     */
    getDominantTraits(traits, topN = 5) {
 ...
 */
export function dampenTraitUpdate(current, delta) {
